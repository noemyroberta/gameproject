...
class UI:
    def __init__(self, surface):
        ...
        self.coin_rect = self.coin.get_rect(topleft = (50, 51))
    ...
    def show_coins(self, amount):
        ...
        coint_amount_surf = self.font.render(str(amount), False, '#33323d')
        coint_amount_rect = coint_amount_surf.get_rect(midleft = (self.coin_rect.right, self.coin_rect.centery))
